...
export default function App() {
  return (
    <div className="min-h-screen font-sans bg-gradient-to-br from-gray-900 via-purple-900 to-indigo-900 text-white">
      ...
      <Routes>
        {/* НАЧАЛНА СТРАНИЦА (ГЕЙМИНГ ПОРТАЛ) */}
        <Route path="/" element={
          <div className="container mx-auto px-4 py-16">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 max-w-6xl mx-auto">
              ...
              <Link 
                to="/bulls" 
                className="group relative bg-white/10 backdrop-blur-md border border-white/20 rounded-3xl overflow-hidden hover:bg-white/20 transition-all duration-300 hover:shadow-[0_0_40px_rgba(129,140,248,0.4)] hover:-translate-y-2 flex flex-col"
              >
                ...
                <div className="p-6 flex-1 flex flex-col">
                  ...
                  <p className="text-indigo-100 text-sm mb-6 flex-1 leading-relaxed">
                    Класическа логическа игра. Използвай ума си и жокери, за да познаеш тайното число!
                  </p>
              ...
              <Link 
                to="/hangman" 
                className="group relative bg-white/10 backdrop-blur-md border border-white/20 rounded-3xl overflow-hidden hover:bg-white/20 transition-all duration-300 hover:shadow-[0_0_40px_rgba(248,113,113,0.4)] hover:-translate-y-2 flex flex-col"
              >
                ...
                <div className="p-6 flex-1 flex flex-col">
                  ...
                  <p className="text-indigo-100 text-sm mb-6 flex-1 leading-relaxed">
                    Спаси човечето, като познаеш скритата дума буква по буква. Внимавай с грешките!
                  </p>
                  <div className="text-yellow-400 font-bold text-base flex items-center gap-2 group-hover:text-yellow-300">
                    <span>Играй сега</span>
                    <span className="group-hover:translate-x-2 transition-transform duration-300">➡️</span>
